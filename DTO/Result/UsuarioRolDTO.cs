...
{
    public class UsuarioRolDTO : Auditoria
    {
    ...
    public class UsuarioRolDetDTO : Auditoria
    {
    ...
    public class UsuarioRolNuevoDTO : UsuarioRolDTO
    {
        public List<UsuarioRolDetDTO> rolDetalle { get; set; }
    }
}
